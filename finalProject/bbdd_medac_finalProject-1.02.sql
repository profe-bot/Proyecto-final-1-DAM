...
-- (in progress) If a table A has a fk that references a table B pk then that B needs to be above A else the table is never created and the problem will undermine the BBDD
-- (done) Every table has a foreign key, this is not possible, revise
-- (done) Alternatively, the ER diagram requires a specialization on Cartas so that all these categories of Cartas can reference the parent entity Carta
-- (in progress) the Inserts need to be added Immediately
...
GRANT SELECT ON *.* TO `bbdd-usuario`;
...
INSERT INTO `visitantes`(`fecha`,`pantalla_aspecto`,`tiempo_locale`)
VALUES
	('2024-04-10','16:9','12:02:30'),
    ('2024-04-15', '16:9', '14:33:41'),
    ('2024-04-15', '18:9', '15:46:30'),
    ('2024-04-16', '19:9', '11:25:02'),
    ('2024-04-16', '16:9', '16:55:00'),
    ('2024-04-17', '16:9', '11:00:32');
...
INSERT INTO `usuarios`(`id_usuario`,`nombre_usuario`,`contrasena`,`mazos_creados`,`id_visitante`,`id_mazo`)
VALUES
	(1,'username','password',1,1,1),
    (2,'username','password',1,2,1);
